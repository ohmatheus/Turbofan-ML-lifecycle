...
feedback_counter = Counter(name="rul_feedback_total", documentation="Total feedback entries received")
feedback_accuracy_histogram = Histogram(
    name="rul_prediction_accuracy", documentation="Distribution of prediction errors"
)
feedback_rmse_histogram = Histogram(name="rul_rmse", documentation="Distribution of rmse")
